...
# 8 "../lib/lapithread.c" 2

hand_t api_exel_thread(void* file,uint_t flgs)
{
    hand_t rethand;
    __asm__ __volatile__( "mov r0,%[snr] \n\t" "mov r1,%[prv1] \n\t" "mov r2,%[prv2] \n\t" "swi 0 \n\t" "mov %[retval],r0 \n\t" :[retval] "=r" (rethand) :[snr] "r" (0x3),[prv1]"r" (file), [prv2] "r" (flgs) :"r0","r1","r2","lr","cc","memory" );
    return rethand;
}
...
{
    uint_t rs,pv1=0;
    __asm__ __volatile__( "mov r0,%[snr] \n\t" "mov r1,%[prv1] \n\t" "swi 0 \n\t" "mov %[retval],r0 \n\t" :[retval] "=r" (rs) :[snr] "r" (0x4),[prv1]"r" (pv1) :"r0","r1","lr","cc","memory" );
    return;
}
...
{
    hand_t rethand;
    __asm__ __volatile__( "mov r0,%[snr] \n\t" "mov r1,%[prv1] \n\t" "swi 0 \n\t" "mov %[retval],r0 \n\t" :[retval] "=r" (rethand) :[snr] "r" (0x5),[prv1]"r" (tname) :"r0","r1","lr","cc","memory" );
    return rethand;
}
...
{
    sysstus_t rets;
    __asm__ __volatile__( "mov r0,%[snr] \n\t" "mov r1,%[prv1] \n\t" "mov r2,%[prv2] \n\t" "mov r3,%[prv3] \n\t" "mov r4,%[prv4] \n\t" "swi 0 \n\t" "mov %[retval],r0 \n\t" :[retval] "=r" (rets) :[snr] "r" (0x6),[prv1]"r" (thand), [prv2] "r" (scode),[prv3]"r" (data), [prv4] "r" (buf) :"r0","r1","r2","r3","r4","lr","cc","memory" );
    return rets;
}
...
{
    sysstus_t rets;
    __asm__ __volatile__( "mov r0,%[snr] \n\t" "mov r1,%[prv1] \n\t" "mov r2,%[prv2] \n\t" "mov r3,%[prv3] \n\t" "mov r4,%[prv4] \n\t" "swi 0 \n\t" "mov %[retval],r0 \n\t" :[retval] "=r" (rets) :[snr] "r" (0x7),[prv1]"r" (thand), [prv2] "r" (scode),[prv3]"r" (data), [prv4] "r" (buf) :"r0","r1","r2","r3","r4","lr","cc","memory" );
    return rets;
}
