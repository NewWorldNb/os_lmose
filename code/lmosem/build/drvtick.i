...
# 8 "../drivers/drvtick.c" 2

void init_s3c2440_timer4()
{
    u32_t cfgtmp=hal_io32_read(0x51000000);
    cfgtmp&=0xffff00ff;
    cfgtmp|=0xff00;
    hal_io32_write(0x51000000,cfgtmp);

    cfgtmp=hal_io32_read(0x51000004);
    cfgtmp&=(0xfff0ffff);
    hal_io32_write(0x51000004,cfgtmp);

    hal_io32_write(0x5100003c,0x41);

    cfgtmp=hal_io32_read(0x51000008);
    cfgtmp&=0xff8fffff;
    hal_io32_write(0x51000008,cfgtmp);
...
void systick_set_driver(driver_t* drvp)
{
    drvp->drv_dipfun[0]=systick_open;
    drvp->drv_dipfun[1]=systick_close;
    drvp->drv_dipfun[2]=systick_read;
    drvp->drv_dipfun[3]=systick_write;
    drvp->drv_dipfun[4]=systick_lseek;
    drvp->drv_dipfun[5]=systick_ioctrl;
    drvp->drv_dipfun[6]=systick_dev_start;
    drvp->drv_dipfun[7]=systick_dev_stop;
    drvp->drv_dipfun[8]=systick_set_powerstus;
    drvp->drv_dipfun[9]=systick_enum_dev;
    drvp->drv_dipfun[10]=systick_flush;
    drvp->drv_dipfun[11]=systick_shutdown;
...
drvstus_t systick_entry(driver_t* drvp,uint_t val,void* p)
{
    ...
    if(krlnew_devhandle(devp,systick_handle,(14 +0))==(-1))
    {
