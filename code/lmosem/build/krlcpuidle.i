...
thread_t* new_cpuidle_thread()
{
    thread_t* ret_td=0;
    bool_t acs=0;
    size_t usrstksz=0x8000,krlstksz=0x8000;
    ...
    ret_td->td_privilege=5;
    ret_td->td_priority=64;
    ...
    krlthreadkrlsatck_init(ret_td,(void*)krlcpuidle_main,0xd3,0x13);
    uint_t cpuid=hal_retn_cpuid();
    schdata_t* schdap=&osschedcls.scls_schda[cpuid];
