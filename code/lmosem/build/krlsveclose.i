...
sysstus_t krlsve_core_close(hand_t fhand)
{
    ...
    return (-1);
cl_dev_step:
    if(krlsve_close_device(ondp)==(-1))
    {
        return (-1);
    }

    if(krlthd_del_objnode(tdp,fhand)==(-1))
    {
