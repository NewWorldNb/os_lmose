...
# 13 "../include/knlinc/krlglobal.h"
 __attribute__((section(".data"))) kmempool_t oskmempool;
 __attribute__((section(".data"))) schedclass_t osschedcls;
 __attribute__((section(".data"))) ktime_t osktime;
 __attribute__((section(".data"))) syscall_t osscalltab[0xf];
 __attribute__((section(".data"))) devtable_t osdevtable;
 __attribute__((section(".data"))) drventyexit_t osdrvetytabl[];
...
krlsvetabl_time};
 __attribute__((section(".data"))) devtable_t osdevtable;
 __attribute__((section(".data"))) drventyexit_t osdrvetytabl[]={
systick_entry,uart_entry,rtc_entry,
0};
